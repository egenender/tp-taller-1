...
EstadoIntroduccion4 EstadoIntroduccion4::instancia;

// Introduccion del juego
EstadoIntroduccion4::EstadoIntroduccion4() {
	camara = NULL;
	fondo = NULL;
	yoshiNormal = NULL;
	x = 0;
...
void EstadoIntroduccion4::iniciar() {
...
/** Termina el estado **/
void EstadoIntroduccion4::terminar() {
	if (yoshiNormal) {
		delete (yoshiNormal);
		yoshiNormal = NULL;
	}
...
/** Actualiza el estado **/
void EstadoIntroduccion4::actualizar(float delta) {
	x += dx * delta;
	y += dy * delta;
...
/** Dibuja el estado **/
void EstadoIntroduccion4::dibujar(SDL_Surface* display) {
...
EstadoIntroduccion4* EstadoIntroduccion4::obtenerInstancia() {
	return &instancia;
}


/** Maneja eventos que vienen del teclado **/
void EstadoIntroduccion4::manejarEvento(SDL_Event* evento) {
